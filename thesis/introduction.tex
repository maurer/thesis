...
Access to external code important to allow the use of already existing analysis code, such as BAP~\cite{bap} lifting and ELF parsing.
...
We provide a formal semantics for our logic language (\S~\ref{chap:formal}).
