...
%TODO impl doesn't reeealy discuss callbacks at the moment, I should drop a note there and make this reference more specific
The use of callbacks allows us both to more easily implement the engine (\S~\ref{holmes:sec:impl}).
