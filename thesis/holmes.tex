...
\todo{Describe how it works with real circumscription}
%Real circumscription:
%Assumptions now take the form of an additional rule which says "If there is a \vec{a} for this \vec{x} that is bigger than mine, produce \bot
% Will need to rewrite previous "addl restriction" into a rule transformation for this.
\paragraph{call/cc}
