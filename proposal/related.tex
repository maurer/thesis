...
Existing binary code analysis platforms\cite{jakstab,bap}\todo{enumerate more} still explicitly schedule analyses, in part due to the cyclic dependencies in their components.
