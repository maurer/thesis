...
\begin{gather*}
  ...
  \infer[assume]{\Gamma; \Delta, (\vec{\sigma}, \tau, P^\tau) \ds e : Q}{\Gamma; \Delta \ds e: (\not \exists \gamma, b. (\gamma \not \in \vec{\sigma}) \wedge b : P^\tau[\tau/\gamma]) \Rightarrow Q & \forall a : P^\tau[\tau/\rho] \in \Gamma. \rho \in \vec{\sigma}}\\
  \infer[unassume]{\Gamma; \Delta \ds e : (\not \exists \gamma, b. (\gamma \not \in \vec{\sigma}) \wedge b : P^\tau[\tau/\gamma]) \Rightarrow Q}{\Gamma; \Delta, (\vec{\sigma}, \tau, P^\tau) \ds e : Q}\\
  \infer[call/cc]{\Gamma; \Delta, (\vec{\sigma'}, \tau, P^\tau) \ds callcc(e) : P^\tau[\tau/\rho]}{\Gamma; \Delta, (\vec{\sigma}, \tau, P^\tau) \ds e : P^\tau[\tau/\rho] & \vec{\sigma'} = \vec{\sigma} + \rho}
\end{gather*}
