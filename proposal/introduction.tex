...
\begin{inset}
{\bf Thesis statement.}
Codependence in binary program analysis can be represented in a logic language framework that allows for formal reasoning about the derivation of its conclusions.
\end{inset}
