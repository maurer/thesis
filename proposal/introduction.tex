...
As a result, practical systems~\cite{bap}\todo{find more} frequently have a fallback analysis for use when VSA fails.
...
\section{Timeline}
I plan to complete my thesis before Aug 2016.\todo{Generalize my personal timeline}
\begin{itemize}[label={}]
