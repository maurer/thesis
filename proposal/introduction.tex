...
\begin{inset}
{\bf Thesis statement.}
Codependence in binary program analysis can be represented in a logic language framework that allows for formal reasoning about the derivation of its conclusions and increased modularity of analyses.
\end{inset}
...
\begin{itemize}
       ...
       \end{itemize}
       \item A real system implementation --- designing \sysname\ such that it is stable, efficient, and usable enough to see continued use after the completion of this thesis.
\end{itemize}
